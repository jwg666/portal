	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid({
			...
			columns : [ [ 
			   ...
			   {field:'dicCode',title:'dicCode',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {}
					},
			   ...
			   {field:'dicValue',title:'dicValue',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {}
					},
			   ...
			   {field:'parentCode',title:'parentCode',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {}
					},
			   ...
			   {field:'dicType',title:'1地区 2.民族 3.人群类别 4.申请事项 5.处理阶段 6.文化程度 7.案件理由',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {}
					},
