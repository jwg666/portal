	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid({
			...
			columns : [ [ 
			   ...
			   {field:'tbid',title:'tbid',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
			   ...
			   {field:'resourceId',title:'resourceId',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {required:true}
					},
			   ...
			   {field:'roleId',title:'roleId',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {required:true}
					},
