	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid({
			...
			columns : [ [ 
			   ...
			   {field:'createBy',title:'createBy',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {}
					},
			   ...
			   {field:'deletedFlag',title:'deletedFlag',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {}
					},
			   ...
			   {field:'description',title:'description',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {}
					},
			   ...
			   {field:'gmtCreate',title:'gmtCreate',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'datetimebox',
							options : {}
					},
			   ...
			   {field:'gmtCreateString',title:'gmtCreateString',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {}
					},
			   ...
			   {field:'gmtModified',title:'gmtModified',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'datetimebox',
							options : {}
					},
			   ...
			   {field:'gmtModifiedString',title:'gmtModifiedString',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {}
					},
			   ...
			   {field:'lastModifiedBy',title:'lastModifiedBy',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {}
					},
			   ...
			   {field:'usingFlag',title:'usingFlag',align:'center',sortable:false,width : 85,
			  	    editor : {
							type : 'validatebox',
							options : {}
					},
