...
<script type="text/javascript">
	...
	function sendMessage(){
		//mailEditor.getData();
		var type = "0";
		var display = $("#Announcementid").css('display');
		if(display!="none"){
			type = "2";
		}
	...
	function hideSendUser(){
		...
		if(dis=="none"){
			$("#Announcementid").text("为所有人发送");
			$("#senduser").css('display','');
		}else{
			$("#Announcementid").text("返回");
	...
	<div name="sub" style="z-index: 0">
		<div class="sendbox">
			<div class="sBtnbox">
				...
				<button class="sBtn sendBtn" onclick="sendMessageInit()" type="button" name="sendBtn" id="sendMessageid">发送公告</button>
				<button class="sBtn sendBtn" onclick="hideSendUser()" style="display: none" id="Announcementid">为所有人发送</button>
				...
				<button disabled="disabled" class="disabled sBtn" type="button"
