...
/* $("#messageListTable .locDataCheckTd").on("click",function(){
	return false;
				...
				<div class="toolbar toolbartop" style="display: block;">
					...
					<div title="删除" class="dropBtn" onclick="delgg()" name="delBtn">删除</div>
					...
					<div class="pager">
						...
						<span class="pager_s">共${messagePager.totalRecords}条</span>
						...
						<span class="gotopager btmgotopager cc" disabled="disabled">
							...
							第<s:textfield type="text" id="toPageNum" size="1" nme="messageQuery.page" ></s:textfield>页						
						</span>
					...
					<div class="search">
						...
						<s:textfield id="searchTitle" type="text" cssClass="topsearch" ></s:textfield>
				...
				<div class="mailscrollwrap">
					<div style="overflow: auto;" class="mailbox">
						...
						<table width="100%" id="messageListTable" cellspacing="0" cellpadding="0" border="0" class="">
							<tbody>
							<s:iterator value="messagePager.records"  var="messageMap" >
								<tr data="${messageMap['MESSAGE_ID']}" class="">
									...
									<td class="mailcx locDataCheckTd"><input type="checkbox"
										value="${messageMap['ID'] }"	class="iptChk ipt" name="dataCheck"></td>
									<td class="mailfg" name="starBtn"><i class="staroff"></i>
									...
									<td class="mailgt"><div class="mailttbox">
											<span class="mailtt ">[用户公告]${messageMap['TITLE']}</span>
										</div></td>
