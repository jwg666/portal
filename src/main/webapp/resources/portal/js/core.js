...
var ajaxUrl   = '/portal/portal/ajax';     //所有ajax操作指向页面
var zoomlevel = 1;
var TEMP      = {};
var HROS      = {};
...
//	暂时不使用
	...
	deskHome		:6,
	//-----------------------------url---------------
	basicStaticUrl	:'/portal/assets',
	basicDynamicUrl	:'/portal',
	basicActionUrl	:'/portal/portal',
	downloadImage	:'/portal/portal/fileUpload/downloadImage?fileId=',
	//-------------------------------locale------------------
	locale : 'zh_CN'
};
/**
