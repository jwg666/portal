		...
		get : function(callback){
			$.ajax({
				...
				success : function(msg){
					//var w = msg.split('<{|}>');
					var data = msg;
					HROS.CONFIG.wallpaperState = data.wallpaperstate;
					switch(data.wallpaperstate){
						case 1:
						case 2:
							HROS.CONFIG.wallpaper = HROS.CONFIG.downloadImage+data.url;
							HROS.CONFIG.wallpaperType = data.wallpapertype;
							HROS.CONFIG.wallpaperWidth = data.width;
							HROS.CONFIG.wallpaperHeight = data.height;
							break;
						case 3:
							HROS.CONFIG.wallpaper = data.wallpaperwebsite;
							break;
					}
					callback && callback();
				}
