...
_546.ss.clean();
if(opts.beforLoadSuccess&&opts.commonSort==true){
	opts.beforLoadSuccess.call(_545,data);
}
...
if(opts.changeSortNameBeforeLoad&&opts.commonSort==true){
	opts.changeSortNameBeforeLoad.call(_5dd,_5df)
}
...
_5e6=_5e6||{};
//tianjsh 自定义初始化options
if($.fn.datagrid.customInitOptions){
	$.fn.datagrid.customInitOptions(_5e6);
}
//end
return this.each(function(){
